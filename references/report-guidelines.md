...
1. **Executive Summary** (≤ 1 page)
   ...
   - **Top issues by RPN (3):** highest-RPN items, one line each. Must not duplicate themes.
...
4. **Methodology Note**
   ...
   - Fetch method used; freshness verification method (follow-up passes)
...
5. **Appendices**
   ...
   - E. Panel balance tally (structured table per workflow.md Phase 7)
